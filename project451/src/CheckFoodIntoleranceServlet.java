...
/**
 * Servlet implementation class CheckFoodIntoleranceServlet
 */
@WebServlet("/CheckFoodIntoleranceServlet")
public class CheckFoodIntoleranceServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CheckFoodIntoleranceServlet() {
        super();
