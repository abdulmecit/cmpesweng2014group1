      ...
      <div class="row">
        <div class="col-md-offset-3 col-md-6 well">
			...
			<form:form class="form-horizontal" action="homesettings/changeName" method="POST" modelAttribute="user">
		    	<div class="formName">
		    		<div class="form-group">
  						...
  						<div class="col-sm-6">
    						<input type="text" class="form-control" id="inputName" name="inputName" style="width:80%" maxlength="30" value="${user.name}" required>
  						</div>
  					</div>
    				<div class="form-group">
		  ...
		  <div>
			...
			<form:form class="form-horizontal" action="homesettings/changeSurname" method="POST" modelAttribute="user">
		    	<div class="formSurname">
		    		<div class="form-group">
  						<label for="inputSurname" class="col-sm-4 control-label">Surname:</label>
  						<div class="col-sm-6">
    						<input type="text" class="form-control" id="inputSurname" name="inputSurname" style="width:80%" maxlength="30" value="${user.surname}" required>
  						</div>
  					</div>
    				<div class="form-group">
      					<div class="col-sm-offset-2 col-sm-10">
		  ...
		  <div>
		    ...
		    <form:form class="form-horizontal" action="homesettings/changeEmail" method="POST" modelAttribute="user">
		    	<div class="formEmail">
		    		<div class="form-group">
  					<label for="inputEmail" class="col-sm-4 control-label">E-mail:</label>
						<div class="col-sm-6">
						   	<input type="email" class="form-control" id="inputEmail" name="inputEmail" style="width:80%" maxlength="30" value="${user.email}" required>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
		  ...
		  <div>
		    <p id="password">Password: ******* <button id="changePassword"> <img alt="Edit" src="https://cdn2.iconfinder.com/data/icons/windows-8-metro-style/256/edit.png" height="12px"> </button></p>
		  	<form:form class="form-horizontal" action="homesettings/changePassword" method="POST" modelAttribute="user">
		  ...
		  <div>
		    <p id="birthday">Birthday: ${user.birthday} <button id="changeBirthday"> <img alt="Edit" src="https://cdn2.iconfinder.com/data/icons/windows-8-metro-style/256/edit.png" height="12px"> </button></p>
		  	<form:form class="form-horizontal" action="homesettings/changeBirthday" method="POST" modelAttribute="user">
